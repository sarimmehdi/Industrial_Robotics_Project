...
%SINGULARITY CODE STARTS HERE
T1 = SE3(0.5, 0.3, 0.44) * SE3.Ry(pi/2); %wrist singularity
T2 = SE3(0.5, -0.3, 0.44) * SE3.Ry(pi/2); %wrist singularity
% T1 = SE3(0, -0.3, 0) * SE3.Ry(pi/2); %elbow singularity
% T2 = SE3(-0.823, -0.3, 0) * SE3.Ry(pi/2); %elbow singularity
% T1 = SE3(0, -0.3, 0.44) * SE3.Ry(0.42); %shoulder singularity
% T2 = SE3(-0.154, -0.15, 0.741) * SE3.Ry(0.42); %shoulder singularity
t_res = 0.1;
t = [0:t_res:10];
